...
# image = np.array(Image.open('09-05-23_12-32-03.jpeg')) #a
# image = np.array(Image.open('09-05-23_12-28-55.jpeg')) #l
image = np.array(Image.open("rotten_a.jpg")) #a
frame = image
